...
<div class="sidebar-wrapper sidebar-theme">
    <nav id="compactSidebar">
        ...
        <ul class="menu-categories">
            <li class="menu active">
                <a href="{{route('categories')}}" data-active="true" class="menu-toggle {{!Route::is('categories') ? : 'activo'}}">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('products')}}" class="menu-toggle {{!Route::is('products') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('pos')}}" class="menu-toggle {{!Route::is('pos') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('roles')}}" class="menu-toggle {{!Route::is('roles') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('permissions')}}" class="menu-toggle {{!Route::is('permissions') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('asignar')}}" class="menu-toggle {{!Route::is('asignar') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('users')}}" class="menu-toggle {{!Route::is('users') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>
                        </div>
            ...
            <li class="menu">
                <a href="{{route('denominations')}}" class="menu-toggle {{!Route::is('denominations') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('cashout')}}" class="menu-toggle {{!Route::is('cashout') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
            ...
            <li class="menu">
                <a href="{{route('reports')}}" class="menu-toggle {{!Route::is('reports') ? : 'activo'}}" data-active="false">
                    <div class="base-menu">
                        <div class="base-icons">
