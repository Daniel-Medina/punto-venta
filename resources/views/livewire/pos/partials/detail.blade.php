                                    ...
                                    <tr>
                                        <td class="text-center table-th">
                                            ...
                                            @if (count($item->attributes) > 0)
                                                <span><img src="{{Storage::url($item->attributes[0])}}" alt="Imagen del producto" height="90" width="90" class="rounded"></span>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-dark mbmobile" onclick="Confirm('{{$item->id}}', 'removeItem', '¿ELIMINAR EL REGISTRO?')">
